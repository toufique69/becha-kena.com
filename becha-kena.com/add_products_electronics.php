...
// if everything is ok, try to upload file
  ...
  try {
    ...
    $result = mysql_query("insert into product_electronics (ProductId,Brand,Model,Image,Description,Price) values('$_POST[ProductId]','$_POST[Brand]','$_POST[Model]','$target_file','$_POST[Description]','$_POST[Price]') ");
...
?>
  ...
  <body>
      ...
      <form action="" method="post" enctype="multipart/form-data">
        ...
        <h1 style="font-style:italic;font-size:22px">Products Entry: Electronics</h1>
