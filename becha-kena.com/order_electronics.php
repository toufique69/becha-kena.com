...
if(isset($_POST['form1'])) {
	...
	try {
		...
		$result = mysql_query("insert into order_electronics (ProductId,Brand,Model,Quantity,UserName,ContactNumber,DeliveryAddress) values('$_POST[ProductId]','$_POST[Brand]','$_POST[Model]','$_POST[Quantity]','$_POST[UserName]','$_POST[ContactNumber]','$_POST[DeliveryAddress]') ");
...
$result = mysql_query("select * from product_electronics where ElectronicsId='$id'");
