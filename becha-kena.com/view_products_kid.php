...
<table class="table-fill">
	...
	<?php
	$i=0;
	$result = mysql_query("select * from product_kid");
	while($row=mysql_fetch_array($result)) 
	{
		...
		<td class="text-left">
			<a href="edit_kid.php?id=<?php echo $row['KidId']; ?>">Edit</a>&nbsp;|&nbsp;
			<a onclick="return confirm_delete();" href="delete_kid.php?id=<?php echo $row['KidId']; ?>">Delete</a>
		</td>
		</tr>
		<?php
	}
