...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['Price'])) {
      throw new Exception('<span style="font-size:20px;font-weight:bold;margin-left:570px;color:#FF794D;font-style:italic;font-family:Times New Roman">Price can not be empty</span>');
		...
		$result = mysql_query("update product_watch set ProductId='$_POST[ProductId]',Brand='$_POST[Brand]',Model='$_POST[Model]',Description='$_POST[Description]',Price='$_POST[Price]' where WatchId='$id'");
