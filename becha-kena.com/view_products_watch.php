...
<table class="table-fill">
	...
	<?php
	$i=0;
	$result = mysql_query("select * from product_watch");
	while($row=mysql_fetch_array($result)) 
	{
		...
		<td class="text-left">
			<a href="edit_watch.php?id=<?php echo $row['WatchId']; ?>">Edit</a>&nbsp;|&nbsp;
			<a onclick="return confirm_delete();" href="delete_watch.php?id=<?php echo $row['WatchId']; ?>">Delete</a>
		</td>
		</tr>
		<?php
	}
