...
if(isset($_POST['form1'])) {
	...
	try {
		...
		$result = mysql_query("insert into order_shoes (ProductId,Model,Size,Quantity,UserName,ContactNumber,DeliveryAddress) values('$_POST[ProductId]','$_POST[Model]','$_POST[Size]','$_POST[Quantity]','$_POST[UserName]','$_POST[ContactNumber]','$_POST[DeliveryAddress]') ");
