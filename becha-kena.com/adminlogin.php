...
if(isset($_POST['form_login'])) 
{
	...
	try {
		...
		include('config.php');
		$num=0;
		$result = mysql_query("select * from admin_information where UserName='$_POST[UserName]' and Password='$Password'");
...
<img src="images/logo.png"/>
				...
				<form action="" method="post">
					<li>
						<input type="text" name="UserName" value="USERNAME" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'USERNAME';}" ><a href="#" class=" icon user"></a>
					</li>
					<li>
