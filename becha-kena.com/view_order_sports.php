...
<table class="table-fill">
	...
	<?php
	$i=0;
	$result = mysql_query("select * from order_sports");
	while($row=mysql_fetch_array($result)) 
	{
		...
		<td>
			<a onclick="return confirm_delete();" href="delete_order_sports.php?id=<?php echo $row['PId']; ?>">Delete</a>
		</td>
		</tr>
		<?php
	}
