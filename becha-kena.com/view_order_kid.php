...
<html lang="en">
<head>
<title>View Order | Kid Corners</title>
...
<table class="table-fill">
	...
	<?php
	$i=0;
	$result = mysql_query("select * from order_kid");
	while($row=mysql_fetch_array($result)) 
	{
		...
		<td>
			<a onclick="return confirm_delete();" href="delete_order_kid.php?id=<?php echo $row['PId']; ?>">Delete</a>
		</td>
		</tr>
		<?php
	}
