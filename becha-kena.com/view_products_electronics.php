...
<table class="table-fill">
	...
	<?php
	$i=0;
	$result = mysql_query("select * from product_electronics");
	while($row=mysql_fetch_array($result)) 
	{
		...
		<td class="text-left">
			<a href="edit_electronics.php?id=<?php echo $row['ElectronicsId']; ?>">Edit</a>&nbsp;|&nbsp;
			<a onclick="return confirm_delete();" href="delete_electronics.php?id=<?php echo $row['ElectronicsId']; ?>">Delete</a>
		</td>
		</tr>
		<?php
	}
