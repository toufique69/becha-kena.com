...
// if everything is ok, try to upload file
  ...
  try {
    ...
    $result = mysql_query("insert into product_shoes (ProductId,Model,Size,Image,Description,Price) values('$_POST[ProductId]','$_POST[Model]','$_POST[Size]','$target_file','$_POST[Description]','$_POST[Price]') ");
...
?>
  ...
  <body>
      ...
      <form action="" method="post" enctype="multipart/form-data">
        ...
        <h1 style="font-style:italic;font-size:22px">Products Entry: Shoes</h1>
        
        <fieldset>
          <label for="mail">Product Id:</label>
          <input type="text" id="mail" name="ProductId">

          <label>Model:</label>
          <input type="text" id="mail" name="Model">

          <label for="mail">Size:</label>
          <input type="text" id="mail" name="Size">

          <label for="bio">Image:</label>
          <input type="file" name="fileToUpload" id="fileToUpload">

          <label for="bio"><br>Description:</label>
