...
<table class="table-fill">
	...
	<?php
	$i=0;
	$result = mysql_query("select * from product_sports");
	while($row=mysql_fetch_array($result)) 
	{
		...
		<td class="text-left">
			<a href="edit_sports.php?id=<?php echo $row['SportsId']; ?>">Edit</a>&nbsp;|&nbsp;
			<a onclick="return confirm_delete();" href="delete_sports.php?id=<?php echo $row['SportsId']; ?>">Delete</a>
		</td>
		</tr>
		<?php
	}
