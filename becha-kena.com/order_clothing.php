...
if(isset($_POST['form1'])) {
	...
	try {
		...
		if(empty($_POST['Name'])) {
			throw new Exception('<span style="font-size:20px;margin-left:570px;color:#FF794D;text-align:center;;font-style:italic;font-family:Times New Roman;font-weight:bold">Name can not be empty</span>');
		}
		...
		if(empty($_POST['Size'])) {
			throw new Exception('<span style="font-size:20px;margin-left:570px;color:#FF794D;text-align:center;;font-style:italic;font-family:Times New Roman;font-weight:bold">Size can not be empty</span>');
		}
		...
		$result = mysql_query("insert into order_clothing (Name,Type,Brand,Size,Quantity,UserName,ContactNumber,DeliveryAddress) values('$_POST[Name]','$_POST[Type]','$_POST[Brand]','$_POST[Size]','$_POST[Quantity]','$_POST[UserName]','$_POST[ContactNumber]','$_POST[DeliveryAddress]') ");
